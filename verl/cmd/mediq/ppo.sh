...
TRAIN_FILE="${TRAIN_FILE:-${DATA_DIR}/train_beta_known_dtg.parquet}"
VAL_FILE="${VAL_FILE:-${DATA_DIR}/val_beta_known_dtg.parquet}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-PPO-7B-turn8-dtg-do-as-do-bt-fixed}"
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.as_cf="${AS_CF}" \
    algorithm.bt_cf="${BT_CF}" \
