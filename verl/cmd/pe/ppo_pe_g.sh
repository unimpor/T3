...
TRAIN_FILE="${TRAIN_FILE:-${DATA_DIR}/train_dtg_S3.parquet}"
VAL_FILE="${VAL_FILE:-${DATA_DIR}/val_dtg_S3.parquet}"

AS_BONUS="${AS_BONUS:-true}"
BT_BONUS="${BT_BONUS:-true}"
BONUS_MODE="${BONUS_MODE:-minority_fixed}"
BONUS_SCALE="${BONUS_SCALE:-0.2}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-Qwen7B-gated3-as-bt}"
